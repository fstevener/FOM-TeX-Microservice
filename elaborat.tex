...
%	\printbibliography[type=online,title={KI-Verzeichnis}]
	...
	\begin{description}
		\item[OpenAI ChatGPT] 
		Verwendet zur sprachlichen Überarbeitung, Strukturierung und Unterstützung bei der Literaturrecherche. 
		Verwendetes Modell: GPT-5.6 Sol. Zugriff am 15.08.2026.

		\item[Weitere KI-Anwendung]
