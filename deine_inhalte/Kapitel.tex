...
Das \textit{Datenbankschema} definiert die Struktur der Datenbank. Es ist eine strukturierte Menge von Metadaten, wird mit der SQL Data Definition Language (DDL) erzeugt und im Systemkatalog des \textit{Datenbankmanagementsystems} (kurz \textit{DBMS}) gespeichert. Im Folgenden wird der Begriff \textit{Schema} synonym für das Datenbankschema verwendet. Schemata sind für die Abfrage, Aktualisierung, Integration und Konvertierung von Daten erforderlich. Die ANSI-SPARC-Architektur definiert Schemata auf drei verschiedenen Abstraktionsebenen: das \textit{interne Schema}, das \textit{konzeptionelle Schema} und das \textit{externe Schema} (vgl. Abb.~\ref{fig:ansi-sparc}).
